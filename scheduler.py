...
class Scheduler:
    ...
    def run(self) -> None:
        """Метод запускающий планировщик в работу. Изначально я реализовал его
         с бесконечным циклом. Но к планировщику есть ряд требований по
         условию задания и я сломал голову, как их лучше реализовать.
         Вообще это мой первый в жизни планировщик и наверно суть задания не
         в конкретной реализации самого планировщика. :)
